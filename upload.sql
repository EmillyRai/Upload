...
--
-- Host: 127.0.0.1
-- Tempo de geração: 22-Nov-2022 às 00:55
...
--
CREATE DATABASE IF NOT EXISTS `formulario` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `formulario`;
--
-- Banco de dados: `formulario-cadastro`
--
CREATE DATABASE IF NOT EXISTS `formulario-cadastro` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
('root', '[{\"db\":\"upload\",\"table\":\"arquivos\"},{\"db\":\"formulario-cadastro\",\"table\":\"usuarios\"}]');
...
('root', '2022-11-21 23:50:10', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"pt\"}');
...
INSERT INTO `arquivos` (`id`, `nome`, `path`, `data_upload`, `usuario`) VALUES
(2, 'Carta para Emilly .pdf', 'arquivos/63727f27318d8.pdf', '2022-11-14 14:47:19', ''),
(10, 'Orações Adverbiais e Adjetivas.pdf', 'arquivos/6372db3ce4a67.pdf', '2022-11-14 21:20:12', ''),
(18, 'Geometria Espacial.pdf', 'arquivos/6372e0d381c87.pdf', '2022-11-14 21:44:03', ''),
(19, 'Orações Adverbiais e Adjetivas.pdf', 'arquivos/6372e0d3914c0.pdf', '2022-11-14 21:44:03', '');
